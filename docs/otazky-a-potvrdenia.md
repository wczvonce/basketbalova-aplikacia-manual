...
| WATCH parametre | Overiť, kam mobil ukladá zmenu a kto ju môže vykonať. Server číta spoločné systémové parametre. | Hlavné TEST CMS už overené: obsahuje aj prah PPG. Rozsah zápisu z mobilu a práva zostávajú otvorené. |
...
| Klient/CMS | Legenda a hlavné mobilné postupy už overené; doplniť farby kategórií, A, obslužný kód a netestované GS operácie. | Oddelenie pozorovaného ovládania od neoverených zápisov a následkov. |
